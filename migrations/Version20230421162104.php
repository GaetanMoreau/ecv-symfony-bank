 ...
 */
final class Version20230421162104 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE recharge ADD COLUMN carte INTEGER NOT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TEMPORARY TABLE __temp__recharge AS SELECT id, compte_id, montant, recharge_date FROM recharge');
        ...
        $this->addSql('INSERT INTO recharge (id, compte_id, montant, recharge_date) SELECT id, compte_id, montant, recharge_date FROM __temp__recharge');
