 ...
 */
final class Version20230420121446 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE account (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, proprietaire_id INTEGER DEFAULT NULL, solde DOUBLE PRECISION NOT NULL, status BOOLEAN DEFAULT NULL, CONSTRAINT FK_7D3656A476C50E4A FOREIGN KEY (proprietaire_id) REFERENCES user (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE)');
